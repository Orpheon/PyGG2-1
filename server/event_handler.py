...
def Client_Event_Changeteam(networker, game, senderplayer, event):
    player = game.current_state.players[senderplayer.id]
    # TODO: If any, add classlimits here
    ...
    teamchange_event = event_serialize.ServerEventChangeteam(senderplayer.id, event.newteam)
    networker.sendbuffer.append(teamchange_event)
...
eventhandlers[constants.EVENT_PLAYER_CHANGETEAM] = Client_Event_Changeteam
